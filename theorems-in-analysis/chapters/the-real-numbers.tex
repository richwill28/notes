...
\begin{theorem}[The irrationality of $\sqrt{2}$]
  \phantomsection
  \addcontentsline{toc}{section}{The irrationality of $\sqrt{2}$}
...
\begin{definition}[Fields]
  \phantomsection
  \addcontentsline{toc}{section}{Fields}
...
\begin{definition}[Ordered Fields]
  \phantomsection
  \addcontentsline{toc}{section}{Ordered fields}
...
\begin{theorem}[The triangle inequality]
  \phantomsection
  \addcontentsline{toc}{section}{The triangle inequality}
...
\begin{corollary}[The reverse triangle inequality]
  \phantomsection
  \addcontentsline{toc}{section}{The reverse triangle inequality}
...
\begin{theorem}[Cauchy-Schwarz inequality]
  \phantomsection
  \addcontentsline{toc}{section}{Cauchy-Schwarz inequality}
...
\begin{definition}[Upper and lower bounds]
  \phantomsection
  \addcontentsline{toc}{section}{Upper and lower bounds}
...
\begin{definition}[Completeness]
  ...
  bounded above, $A$ has a least upper bound in $S$. In other words,
...
\begin{theorem}[Existence of $\RR$]
  \phantomsection
  \addcontentsline{toc}{section}{Existence of $\RR$}
...
\begin{proofsketch}
  ...
  \begin{definition}[Dedekind cuts]
    \phantomsection
    \addcontentsline{toc}{section}{Dedekind cuts}
    ...
    \begin{enumerate}
      ...
      \item If $p \in C_b$, then there exists some $q \in C_b$ where $q < p$.
    \end{enumerate}
  \end{definition}
...
\begin{theorem}[Uniqueness of $\RR$]
  \phantomsection
  \addcontentsline{toc}{section}{Uniqueness of $\RR$}
...
\begin{proposition}[Axioms of $\RR$]
  \phantomsection
  \addcontentsline{toc}{section}{Axioms of $\RR$}
...
\begin{proposition}[Suprema are unique]
  \phantomsection
  \addcontentsline{toc}{section}{Suprema are unique}
...
\begin{theorem}[Suprema analytically]
  \phantomsection
  \addcontentsline{toc}{section}{Suprema analytically}
...
\begin{theorem}[$0.999\ldots = 1$]
  ...
  \thmlabel{0.999...=1}
  $0.999\ldots$ is a repeating decimal representation of the real number 1.
\end{theorem}
...
\begin{definition}[Density]
  \phantomsection
  \addcontentsline{toc}{section}{Density}
...
\begin{theorem}[$\QQ$ is dense in $\RR$]
  \phantomsection
  \addcontentsline{toc}{section}{$\QQ$ is dense in $\RR$}
...
\begin{corollary}[$\RR \setminus \QQ$ is dense in $\RR$]
  \phantomsection
  \addcontentsline{toc}{section}{$\RR \setminus \QQ$ is dense in $\RR$}
  The irrational numbers are dense in the real numbers.
\end{corollary}

\begin{proof}
  Pick any $x, y \in \RR$ where $x < y$. By \thmref{q-is-dense-in-r},
...
\begin{definition}[Closed and open intervals]
  \phantomsection
  \addcontentsline{toc}{section}{Closed and open intervals}
...
\begin{theorem}[Characterization of intervals]
  \phantomsection
  \addcontentsline{toc}{section}{Characterization of intervals}
...
\begin{theorem}[The nested intervals property]
  \phantomsection
  \addcontentsline{toc}{section}{The nested intervals property}
