...
\begin{definition}[Bounded sequences]
  \phantomsection
  \addcontentsline{toc}{section}{Bounded sequences}
...
\begin{definition}[Convergent sequences]
  \phantomsection
  \addcontentsline{toc}{section}{Convergent sequences}
...
\begin{definition}[Convergent sequences (topological version)]
  \phantomsection
  \addcontentsline{toc}{section}{Convergent sequences (topological version)}
...
\begin{definition}[Divergent Sequences]
  \phantomsection
  \addcontentsline{toc}{section}{Divergent sequences}
...
\begin{example}
  \explabel{alternating-minus-one-diverges}
...
\begin{proposition}[Limits are unique]
  \phantomsection
  \addcontentsline{toc}{section}{Limits are unique}
...
\begin{proposition}
  \phantomsection
  \addcontentsline{toc}{section}{Convergent sequences are bounded}
...
\begin{theorem}[Sequence limit laws]
  \phantomsection
  \addcontentsline{toc}{section}{Sequence limit laws}
...
\begin{theorem}[Sequence squeeze theorem]
  \phantomsection
  \addcontentsline{toc}{section}{Sequence squeeze theorem}
...
\begin{definition}[Monotone sequences]
  \phantomsection
  \addcontentsline{toc}{section}{Monotone sequences}
...
\begin{theorem}[The monotone convergence theorem]
  \phantomsection
  \addcontentsline{toc}{section}{The monotone convergence theorem}
...
\begin{definition}(Subsequences)
  \phantomsection
  \addcontentsline{toc}{section}{Subsequences}
...
\begin{proposition}
  \phantomsection
  \addcontentsline{toc}{section}{A sequence converges iff every
...
\begin{lemma}
  \phantomsection
  \addcontentsline{toc}{section}{Every sequence has a monotone subsequence}
...
\begin{theorem}[The Bolzano-Weierstrass theorem]
  \phantomsection
  \addcontentsline{toc}{section}{The Bolzano-Weierstrass theorem}
...
\begin{lemma}
  ...
  \phantomsection
  \addcontentsline{toc}{section}{Cauchy sequences are bounded}
...
\begin{theorem}[Cauchy criterion for convergence]
  \phantomsection
  \addcontentsline{toc}{section}{Cauchy criterion for convergence}
...
\begin{theorem}[Stolz-Cesàro theorem]
  \phantomsection
  \addcontentsline{toc}{section}{Stolz-Cesàro theorem}
