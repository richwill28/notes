...
[4.25em]                          % Left margin - adjust this value
{\vspace{0.25em}}                             % Above code (empty to
% preserve default)
{}                             % Numbered format (empty to preserve default)
{}                             % Numberless format (empty to preserve default)
{\titlerule*[0.75pc]{.}\contentspage}                             %
% Filler and page (empty to preserve default)
